...
const profileResource = (path) => ({
  list: (doctorId) =>
    api.get(`/doctors/${doctorId}/${path}`).then((r) => r.data),
  create: (doctorId, data) =>
    api.post(`/doctors/${doctorId}/${path}`, data).then((r) => r.data),
  update: (doctorId, subId, data) =>
    api
      .patch(`/doctors/${doctorId}/${path}/${subId}`, data)
      .then((r) => r.data),
  delete: (doctorId, subId) =>
    api.delete(`/doctors/${doctorId}/${path}/${subId}`).then((r) => r.data),
});
...
export const professionalReferences = profileResource(
  "professional-references",
);

export const disclosures = {
  get: (doctorId) =>
    api.get(`/doctors/${doctorId}/disclosures`).then((r) => r.data),
  save: (doctorId, data) =>
    api.put(`/doctors/${doctorId}/disclosures`, data).then((r) => r.data),
};

// Documents
export const documents = {
  list: (doctorId) =>
    api.get(`/doctors/${doctorId}/documents`).then((r) => r.data),
  upload: (doctorId, type, file, onProgress) => {
    const form = new FormData();
    form.append("file", file);
    return api
      .post(`/doctors/${doctorId}/documents/${type}/upload`, form, {
        headers: { "Content-Type": "multipart/form-data" },
        onUploadProgress: onProgress,
      })
      .then((r) => r.data);
  },
  versions: (doctorId, type) =>
    api
      .get(`/doctors/${doctorId}/documents/${type}/versions`)
      .then((r) => r.data),
  updateStatus: (doctorId, type, data) =>
    api
...
export const workflow = {
  get: (doctorId) =>
    api.get(`/doctors/${doctorId}/workflow`).then((r) => r.data),
  advance: (doctorId) =>
    api.post(`/doctors/${doctorId}/workflow/advance`).then((r) => r.data),
  updateStep: (doctorId, stepId, data) =>
    api
      .patch(`/doctors/${doctorId}/workflow/step/${stepId}`, data)
      .then((r) => r.data),
  missingForms: (doctorId) =>
    api.get(`/doctors/${doctorId}/workflow/missing-forms`).then((r) => r.data),
  sendReminder: (doctorId) =>
    api.post(`/doctors/${doctorId}/workflow/send-reminder`).then((r) => r.data),
};
...
export const alerts = {
  ...
  forDoctor: (doctorId) =>
    api.get(`/alerts/doctor/${doctorId}`).then((r) => r.data),
...
export const tdi = {
  ...
  update: (doctorId, data) =>
    api.patch(`/doctors/${doctorId}/tdi`, data).then((r) => r.data),
};

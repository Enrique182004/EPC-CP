...
const adminItems = [{ to: "/users", label: "Users", icon: "👥" }];
  ...
  return (
    <aside className="w-64 bg-blue-900 text-white flex flex-col shrink-0">
      ...
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
        ...
        {user?.role === "admin" && (
          <>
            <div className="pt-3 pb-1 px-3 text-xs font-semibold text-blue-400 uppercase tracking-wider">
              Admin
            </div>
      ...
      <div className="p-4 border-t border-blue-800">
        ...
        <div className="text-xs text-blue-400 capitalize mb-3">
          {user?.role}
        </div>
        <button

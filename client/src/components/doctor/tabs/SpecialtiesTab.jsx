    ...
    <SubResourceTab
      ...
      renderRow={(row) => (
        <div>
          ...
          {row.board_certified ? (
            <span className="ml-2 badge-green">Board Certified</span>
          ) : null}
          {row.certifying_board && (
            <span className="text-gray-500 ml-2">— {row.certifying_board}</span>
          )}
          {row.expiration_date && (

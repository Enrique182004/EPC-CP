...
app.use('/api/doctors/:id/credentialing-contacts', profile.credentialingContacts);
...
app.use('/api/doctors/:id/professional-references', profile.professionalReferences);
